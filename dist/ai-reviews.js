(() => {
  ...
  async function getStoreInfo(shopId2) {
    const docRef = doc(firestore, `stores/${shopId2}`);
  ...
  async function getProductInfo(shopId2, productId2) {
    const docRef = doc(firestore, `stores/${shopId2}/products/${productId2}`);
    const docSnap = await getDoc(docRef);
